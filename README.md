...
- [video](https://www.youtube.com/watch?v=cmi-AXKvx30&t=323s) David Clark (1960's vs. 1870/80's)  
  "But wha's interesting, is once the engineers got a hold, the visionaries went away ([timestamp](https://www.youtube.com/watch?v=cmi-AXKvx30&t=253s))"
...
Here the usage of the term "compiler" flexibly maps to any kind of code transpiling, from bundling through to binary compilation outputs (eg, rust/wasm).
