...
[Monorepo](https://en.wikipedia.org/wiki/Monorepo) for the set of `core system` modules that compose into a late-bound (strongly typed) distributed "cell" network.
