...
[Monorepo](https://en.wikipedia.org/wiki/Monorepo) comprising the set of `core system` modules that flexibly compose into a late-bound (strongly typed) distributed "cell" network.
