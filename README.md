...
[Monorepo](https://en.wikipedia.org/wiki/Monorepo) for the set of `systems` modules that compose up into a super late-bound (AND strongly typed) distributed "cell" platform.
