...
describe('FsDriver (IndexedDB)', () => {
  ...
  describe('paths', (e) => {
    ...
    it.skip('resolve (file:uri => path)', async () => {
      // const { fs } = await testCreate();
    ...
    it.skip('resolve: SIGNED/post', async () => {
      // const { fs } = await testCreate();
    ...
    it.skip('resolve: throws if non-DEFAULT operation specified', async () => {
      // const { fs } = await testCreate();
    ...
    it.skip('resolve: throw if not "path:.." or "file:.." URI', async () => {
      // const { fs } = await testCreate();
  ...
  describe('read/write', (e) => {
    ...
    it.skip('write: binary (Uint8Array)', async () => {
      // const { fs, sample } = await testCreate();
      //
      // const test = async (uri: string) => {
    ...
    it.skip('read/write: "string" (TextEncoder | TextDecoder)', async () => {
      // const { fs } = await testCreate();
      //
    ...
    it.skip('step up path navigation ("../..")', async () => {
      // const { fs, sample } = await testCreate();
      //
      // const root = slug();
  ...
  describe('delete', (e) => {
    ...
    it.skip('delete (one, with second path reference remaining)', async () => {
      // const { fs } = await testCreate();
      // const data = new TextEncoder().encode(slug());
      //
  ...
  describe('copy', (e) => {
    ...
    it.skip('error: source file does not exist', async () => {
      // const { fs } = await testCreate();
      // const sourceUri = `file:${slug()}:bird1`;
      // const targetUri = `path:${slug()}/foo.png`;
      //
  ...
  describe('errors', (e) => {
    ...
    it.skip('fail: step up above root dir', async () => {
      // const { fs, sample } = await testCreate();
      // const png = sample.data;
      //
    ...
    it.skip('exception: no data', async () => {
      // const { fs } = await testCreate();
      // let message = '';
      // try {
